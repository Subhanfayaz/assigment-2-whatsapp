...
class CallView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: ListView(
          children: const [
            Text("Calls", style: TextStyle(fontSize: 25),),
            ListTile(
            ...
            title: Text("Fayaz"),
            subtitle:  Text("Today"),
            trailing: Icon(Icons.call_end), // we can take row and column in it for multiple icons and many more
          ),
          ListTile(
            tileColor: Colors.white,
            leading: CircleAvatar(
            ...
            title: Text("Subhan"),
            subtitle:  Text("Today"),
            trailing: Icon(Icons.call_made), // we can take row and column in it for multiple icons and many more
          ),
          ListTile(
            tileColor: Colors.white,
            leading: CircleAvatar(
            ...
            title: Text("Abuzar"),
            subtitle:  Text("Today"),
            trailing: Icon(Icons.call_missed), // we can take row and column in it for multiple icons and many more
          ),
          ListTile(
            tileColor: Colors.white,
            leading: CircleAvatar(
            ...
            title: Text("Amaar"),
            subtitle:  Text("Today"),
            trailing: Icon(Icons.call_received), // we can take row and column in it for multiple icons and many more
          ),])
    );
  }
}